...
RSpec.describe Idea do
  ...
  it "has a description" do # yep, you can totally use 'it'
    idea = Idea.create!(description: "My Awesome Idea Name") # creating a new idea 'instance'
    expect(idea.description).to eq("My Awesome Idea Name") # this is our expectation
  end
  it "has comments" do
